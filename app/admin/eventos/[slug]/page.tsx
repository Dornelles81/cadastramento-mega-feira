 ...
 *
 * As colunas de e-mail e telefone nasceram com ✉️ e 💬 e apareceram como
 * QUADRADO VAZIO na máquina de quem usa a tela: emoji depende de a fonte do
 * sistema ter aquele caractere, e num painel administrativo não dá para
 * apostar nisso. SVG inline renderiza em qualquer lugar, não muda de desenho
 * entre sistemas e herda a cor do texto por `currentColor`.
 *
 * O envelope vem do Heroicons, que já é dependência do projeto. O do WhatsApp
 * é traçado aqui porque logo de marca não existe no Heroicons — e o pedido era
 * o ícone do WhatsApp, não um balão de fala genérico (que foi exatamente o que
 * 💬 desenhou quando renderizou).
 */
            ...
            >
              <thead className={darkMode ? 'bg-gray-700' : 'bg-gray-50'}>
                <tr>
                  ...
                  <th className={`px-2 md:px-4 py-3 font-semibold text-xs md:text-sm text-center hidden lg:table-cell ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} title="E-mail — clique no ícone para escrever"><EnvelopeIcon className="w-4 h-4 mx-auto" aria-label="E-mail" /></th>
                  <th className={`px-2 md:px-4 py-3 font-semibold text-xs md:text-sm text-center hidden lg:table-cell ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} title="Telefone — clique no ícone para abrir o WhatsApp"><IconeWhatsApp className="w-4 h-4 mx-auto" /></th>
